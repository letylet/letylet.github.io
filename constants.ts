...
export const PROJECTS: Project[] = [
  {
    ...
    tags: ['Unity', 'C#', 'Web', '2D', 'WebGL', 'MindAR'],
    date: {
  ...
  },
  {
    ...
    tags: ['Unity', 'C#', 'Desktop', '3D', 'DOTween'],
    date: {
  ...
  },
  {
    ...
    tags: ['Unity', 'C#','2D', 'Mobile', 'Vuforia', 'AR', 'Game Design'],
  ...
  },
  {
    ...
    tags: ['Unity','C#', '2D', 'Mobile', 'Desktop', 'Ink', 'Bone Editor'],
  ...
  },
  {
    ...
    tags: ['Unity', 'C#', '2D', 'Desktop', 'DOTween', 'Game Design'],
    images: ['mascaria.png'],
    date: {
      it: 'Gennaio 2026',
      en: 'January 2026'
